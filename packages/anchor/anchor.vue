...
.peony-anchor-wrapper {
  overflow: auto; padding-left: 4px; padding-right: 4px;
...
.peony-anchor-ink {
  ...
  &:before {
    content: ' '; position: relative; width: 2px; height: 100%;
    display: block; background-color: #e8eaec; margin: 0 auto;
  }
  .peony-anchor-ink-ball {
    display: inline-block; position: absolute; left: 50%; width: 6px; height: 6px;
    border-radius: 50%; border: 2px solid #2d8cf0; background-color: #fff;
    transition: top 0.2s ease-in-out; transform: translate(-50%, 2px);
  }
}
.peony-anchor.fixed .peony-anchor-ink .peony-anchor-ink-ball {
  display: none;
}
</style>
